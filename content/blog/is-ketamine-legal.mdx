...
Ketamine is legal for medical use in all 50 states when prescribed by a licensed physician. However, telehealth prescribing rules and state medical board regulations vary. Below is an overview of ketamine therapy availability in the states where Isha Health currently operates.
