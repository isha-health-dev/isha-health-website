...
export const metadata: Metadata = {
  ...
  description: "Online ketamine-assisted therapy in Austin, Texas. Physician-led at-home treatment for depression, anxiety, and PTSD. At-home, by therapist referral.",
