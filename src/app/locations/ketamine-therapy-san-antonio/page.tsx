...
export const metadata: Metadata = {
  ...
  description: "Physician-led online ketamine therapy in San Antonio, Texas for depression, anxiety, PTSD. At-home, no clinic visits. New patients by therapist referral.",
