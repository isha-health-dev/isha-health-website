...
export const metadata: Metadata = {
  ...
  description: "Physician-led online ketamine therapy in Santa Monica, California for depression, anxiety, PTSD. At-home, no clinic visits. Book a consultation.",
  alternates: { canonical: "https://isha.health/locations/ketamine-therapy-santa-monica" },
  openGraph: buildOpenGraph({
    title: "At-Home Ketamine Therapy in Santa Monica, CA",
    description: "Physician-led online ketamine therapy in Santa Monica, California for depression, anxiety, PTSD. At-home, no clinic visits. Book a consultation.",
    path: '/locations/ketamine-therapy-santa-monica',
  }),
  twitter: {
...
export default function Page() {
  ...
  <div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;">
    <nav aria-label="Breadcrumb" style="font-size:0.8rem;color:#6b7280;margin-bottom:1.5rem;font-family:'Poppins',sans-serif;">
      ...
      <span style="color:#9ca3af;">Santa Monica</span>
    </nav>
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:1.05rem;line-height:1.8;color:#374151;margin-bottom:2rem;text-wrap:pretty;">
      If you're in Santa Monica and struggling with depression, anxiety, or PTSD, you don't need to visit a clinic. Isha Health brings physician-led ketamine-assisted therapy directly to you through secure telemedicine — no traffic, no waiting rooms, no disruption to your routine.
    </p>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:2rem;">
      ...
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
        ...
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">Your personalized prescription is sent to a pharmacy and delivered to your door in Santa Monica within 3-5 business days.</p>
      </div>
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
    ...
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1rem;">Why patients in Santa Monica choose Isha Health</h2>
    <ul style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.8;padding-left:1.25rem;margin-bottom:2rem;">
      <li><strong>No clinic visits</strong> — everything is done via telemedicine from your home in Santa Monica</li>
    ...
    <div style="margin-bottom:2rem;">
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How does at-home ketamine therapy work in Santa Monica?</h3>
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">You meet with a physician over video, receive your prescription by mail at your Santa Monica address, and complete sessions at home with ongoing clinical support.</p>
      </div>
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How much does ketamine therapy cost in Santa Monica?</h3>
  ...
  <div style="background-color:#f0fdfa;padding:3rem 1.5rem;text-align:center;border-top:1px solid #ccfbf1;">
    ...
    <p style="font-family:'Poppins',sans-serif;color:#4b5563;margin-bottom:1.5rem;font-size:0.95rem;">Appointments often available within 24 hours for patients in Santa Monica.</p>
