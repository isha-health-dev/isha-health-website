...
export default async function Page() {
  ...
  <div style="max-width:800px;margin:0 auto;padding:1.5rem;" style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;">
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1.25rem;text-wrap:pretty;">
      Beverly Hills, a 32,000-resident city in California (Pacific Time), sits within the LA westside, with quick access from Bel Air, West Hollywood, and Brentwood. Beverly Hills patients typically have access to top-tier private psychiatry but pay rapidly-rising out-of-pocket fees and wait weeks between sessions. Online ketamine therapy at $350/session offers a physician-led, evidence-based alternative without the boutique-clinic markup.
    </p>
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1.25rem;text-wrap:pretty;">
