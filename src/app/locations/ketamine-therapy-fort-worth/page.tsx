...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://isha.health/locations/ketamine-therapy-fort-worth",
  },
  twitter: {
...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How does at-home ketamine therapy work in Fort Worth?", "acceptedAnswer": {"@type": "Answer", "text": "Isha Health provides ketamine therapy via telemedicine for patients in Fort Worth, Texas. You meet with a physician over video for your initial consultation, receive your prescription by mail, and complete sessions at home with ongoing clinical support."}}, {"@type": "Question", "name": "How much does ketamine therapy cost in Fort Worth?", "acceptedAnswer": {"@type": "Answer", "text": "Initial consultation is $350 (60 minutes with a physician). Follow-up appointments are $350 (30 minutes). Medication typically costs $50-150 for a 30-day supply from a compounding pharmacy. HSA/FSA accepted."}}, {"@type": "Question", "name": "Is ketamine therapy legal in Texas?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Ketamine is a Schedule III medication that can be legally prescribed off-label by licensed physicians in Texas for conditions including depression, anxiety, and PTSD. Isha Health physicians are licensed to practice in Texas."}}, {"@type": "Question", "name": "Do I need to visit a clinic?", "acceptedAnswer": {"@type": "Answer", "text": "No. Isha Health is fully telehealth-based. All consultations are conducted via secure video. Your medication is delivered to your home in Fort Worth. No in-person visits required."}}]}</script>
