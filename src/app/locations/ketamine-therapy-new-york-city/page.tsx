...
export const metadata: Metadata = {
  ...
  description: "Online ketamine-assisted therapy in New York City, New York. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required. Book your consultation today.",
  alternates: { canonical: "https://isha.health/locations/ketamine-therapy-new-york-city" },
  openGraph: {
    title: "At-Home Ketamine Therapy in New York City, NY | Isha Health",
    description: "Online ketamine-assisted therapy in New York City, New York. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required. Book your consultation today.",
    type: "website",
...
export default function Page() {
  ...
  <div class="hero-isha">
    <h1 class="heading static-heading">At-Home Ketamine Therapy in New York City, NY</h1>
  </div>
