...
export const metadata: Metadata = {
  ...
  description: "Online ketamine-assisted therapy in Tempe, Arizona. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required.",
  alternates: { canonical: "https://isha.health/locations/ketamine-therapy-tempe" },
  openGraph: {
    title: "At-Home Ketamine Therapy in Tempe, AZ | Isha",
    description: "Online ketamine-assisted therapy in Tempe, Arizona. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required.",
    type: "website",
    images: ["/images/isha_logo.webp"],
    url: "https://isha.health/locations/ketamine-therapy-tempe",
  },
  twitter: {
