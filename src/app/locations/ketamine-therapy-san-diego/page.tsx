...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "At-Home Ketamine Therapy in San Diego, CA | Isha Health",
    description: "Online ketamine-assisted therapy in San Diego, California. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required. Book your consultation today.",
    type: "website",
    url: "https://isha.health/locations/ketamine-therapy-san-diego",
  },
  twitter: {
...
export default function Page() {
  ...
  <div class="hero-isha">
    <h1 class="heading static-heading">At-Home Ketamine Therapy in San Diego, CA</h1>
  </div>
