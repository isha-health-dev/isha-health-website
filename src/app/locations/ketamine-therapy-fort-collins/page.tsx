...
export const metadata: Metadata = {
  ...
  description: "Physician-led online ketamine therapy in Fort Collins, Colorado for depression, anxiety, PTSD. At-home, no clinic visits. Book a consultation.",
  alternates: { canonical: "https://isha.health/locations/ketamine-therapy-fort-collins" },
  openGraph: buildOpenGraph({
    title: "At-Home Ketamine Therapy in Fort Collins, CO",
    description: "Physician-led online ketamine therapy in Fort Collins, Colorado for depression, anxiety, PTSD. At-home, no clinic visits. Book a consultation.",
    path: '/locations/ketamine-therapy-fort-collins',
  }),
  twitter: {
...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How does at-home ketamine therapy work in Fort Collins?", "acceptedAnswer": {"@type": "Answer", "text": "Isha Health provides ketamine therapy via telemedicine for patients in Fort Collins, Colorado. You meet with a physician over video for your initial consultation, receive your prescription by mail, and complete sessions at home with ongoing clinical support."}}, {"@type": "Question", "name": "How much does ketamine therapy cost in Fort Collins?", "acceptedAnswer": {"@type": "Answer", "text": "Initial consultation is $398 (60 minutes with a physician). Follow-up appointments are $398 (30 minutes). Medication typically costs $50-150 for a 30-day supply from a compounding pharmacy. HSA/FSA accepted."}}, {"@type": "Question", "name": "Is ketamine therapy legal in Colorado?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Ketamine is a Schedule III medication that can be legally prescribed off-label by licensed physicians in Colorado for conditions including depression, anxiety, and PTSD. Isha Health physicians are licensed to practice in Colorado."}}, {"@type": "Question", "name": "Do I need to visit a clinic?", "acceptedAnswer": {"@type": "Answer", "text": "No. Isha Health is fully telehealth-based. All consultations are conducted via secure video. Your medication is delivered to your home in Fort Collins. No in-person visits required."}}]}</script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://isha.health"}, {"@type": "ListItem", "position": 2, "name": "Ketamine Therapy in Colorado", "item": "https://isha.health/locations/online-at-home-ketamine-therapy-in-colorado"}, {"@type": "ListItem", "position": 3, "name": "Ketamine Therapy in Fort Collins", "item": "https://isha.health/locations/ketamine-therapy-fort-collins"}]}</script>
  <div style="text-align:center;padding:3rem 1.5rem 1.5rem;">
    <h1 style="font-family:'Libre Baskerville',serif;font-size:2rem;font-weight:700;color:#111827;margin:0;">At-Home Ketamine Therapy in Fort Collins, CO</h1>
  </div>
  <div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;">
    <nav aria-label="Breadcrumb" style="font-size:0.8rem;color:#6b7280;margin-bottom:1.5rem;font-family:'Poppins',sans-serif;">
      ...
      <span style="color:#9ca3af;">Fort Collins</span>
    </nav>
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:1.05rem;line-height:1.8;color:#374151;margin-bottom:2rem;text-wrap:pretty;">
      If you're in Fort Collins and struggling with depression, anxiety, or PTSD, you don't need to visit a clinic. Isha Health brings physician-led ketamine-assisted therapy directly to you through secure telemedicine — no traffic, no waiting rooms, no disruption to your routine.
    </p>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:2rem;">
      ...
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
        ...
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">Your personalized prescription is sent to a pharmacy and delivered to your door in Fort Collins within 3-5 business days.</p>
      </div>
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
    ...
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1rem;">Why patients in Fort Collins choose Isha Health</h2>
    <ul style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.8;padding-left:1.25rem;margin-bottom:2rem;">
      <li><strong>No clinic visits</strong> — everything is done via telemedicine from your home in Fort Collins</li>
    ...
    <div style="margin-bottom:2rem;">
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How does at-home ketamine therapy work in Fort Collins?</h3>
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">You meet with a physician over video, receive your prescription by mail at your Fort Collins address, and complete sessions at home with ongoing clinical support.</p>
      </div>
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How much does ketamine therapy cost in Fort Collins?</h3>
  ...
  <div style="background-color:#f0fdfa;padding:3rem 1.5rem;text-align:center;border-top:1px solid #ccfbf1;">
    ...
    <p style="font-family:'Poppins',sans-serif;color:#4b5563;margin-bottom:1.5rem;font-size:0.95rem;">Appointments often available within 24 hours for patients in Fort Collins.</p>
