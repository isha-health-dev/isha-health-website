...
export const metadata: Metadata = {
  ...
  description: "Physician-led online ketamine therapy in Bend, Oregon for depression, anxiety, PTSD. At-home, no clinic visits. New patients by therapist referral.",
