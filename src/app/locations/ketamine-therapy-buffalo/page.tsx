...
export const metadata: Metadata = {
  ...
  description: "Physician-led online ketamine therapy in Buffalo, New York for depression, anxiety, PTSD. At-home, no clinic visits. New patients by therapist referral.",
