...
export const metadata: Metadata = {
  title: "At-Home Ketamine Therapy in Dallas, TX",
  description: "Online ketamine-assisted therapy in Dallas, Texas. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required. Book your…",
  alternates: { canonical: "https://isha.health/locations/ketamine-therapy-dallas" },
  robots: { index: true, follow: true }, // Major metro — overrides locations/layout.tsx noindex
  openGraph: buildOpenGraph({
    title: "At-Home Ketamine Therapy in Dallas, TX",
    description: "Online ketamine-assisted therapy in Dallas, Texas. Physician-led at-home treatment for depression, anxiety, and PTSD. No clinic visits required. Book your…",
    path: '/locations/ketamine-therapy-dallas',
  }),
  twitter: {
...
export default async function Page() {
  const therapists = await getTherapistsForCity('ketamine-therapy-dallas');
  const therapistsHtml = therapists.length > 0
    ? `
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-top:2.5rem;margin-bottom:1rem;">Ketamine-assisted therapists in Dallas</h2>
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#4b5563;line-height:1.6;margin-bottom:1.25rem;">These licensed clinicians work with Dallas-area patients receiving ketamine therapy. Many can complement your Isha Health treatment with integration support.</p>
  ...
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How does at-home ketamine therapy work in Dallas?", "acceptedAnswer": {"@type": "Answer", "text": "Isha Health provides ketamine therapy via telemedicine for patients in Dallas, Texas. You meet with a physician over video for your initial consultation, receive your prescription by mail, and complete sessions at home with ongoing clinical support."}}, {"@type": "Question", "name": "How much does ketamine therapy cost in Dallas?", "acceptedAnswer": {"@type": "Answer", "text": "Initial consultation is $398 (60 minutes with a physician). Follow-up appointments are $398 (30 minutes). Medication typically costs $50-150 for a 30-day supply from a compounding pharmacy. HSA/FSA accepted."}}, {"@type": "Question", "name": "Is ketamine therapy legal in Texas?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Ketamine is a Schedule III medication that can be legally prescribed off-label by licensed physicians in Texas for conditions including depression, anxiety, and PTSD. Isha Health physicians are licensed to practice in Texas."}}, {"@type": "Question", "name": "Do I need to visit a clinic?", "acceptedAnswer": {"@type": "Answer", "text": "No. Isha Health is fully telehealth-based. All consultations are conducted via secure video. Your medication is delivered to your home in Dallas. No in-person visits required."}}]}</script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://isha.health"}, {"@type": "ListItem", "position": 2, "name": "Ketamine Therapy in Texas", "item": "https://isha.health/locations/online-at-home-ketamine-therapy-in-texas"}, {"@type": "ListItem", "position": 3, "name": "Ketamine Therapy in Dallas", "item": "https://isha.health/locations/ketamine-therapy-dallas"}]}</script>
  <div style="text-align:center;padding:3rem 1.5rem 1.5rem;">
    <h1 style="font-family:'Libre Baskerville',serif;font-size:2rem;font-weight:700;color:#111827;margin:0;">At-Home Ketamine Therapy in Dallas, TX</h1>
  </div>
  <div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;">
    <nav aria-label="Breadcrumb" style="font-size:0.8rem;color:#6b7280;margin-bottom:1.5rem;font-family:'Poppins',sans-serif;">
      ...
      <span style="color:#9ca3af;">Dallas</span>
    </nav>
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:1.05rem;line-height:1.8;color:#374151;margin-bottom:2rem;text-wrap:pretty;">
      If you're in Dallas and struggling with depression, anxiety, or PTSD, you don't need to visit a clinic. Isha Health brings physician-led ketamine-assisted therapy directly to you through secure telemedicine — no traffic, no waiting rooms, no disruption to your routine.
    </p>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:2rem;">
      ...
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
        ...
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">Your personalized prescription is sent to a pharmacy and delivered to your door in Dallas within 3-5 business days.</p>
      </div>
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
    ...
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1rem;">Why patients in Dallas choose Isha Health</h2>
    <ul style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.8;padding-left:1.25rem;margin-bottom:2rem;">
      <li><strong>No clinic visits</strong> — everything is done via telemedicine from your home in Dallas</li>
    ...
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-top:2.5rem;margin-bottom:1rem;">About ketamine therapy in Dallas</h2>
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1.25rem;text-wrap:pretty;">
      Dallas, a 1.3 million-resident city in Texas (Central Time), sits within the Dallas-Fort Worth metro of 8 million. Dallas's rapid growth has outpaced its in-network behavioral-health supply: many residents wait 6–12 weeks for a psychiatrist accepting their insurance. Telehealth ketamine therapy fills that gap with a same-week option for treatment-resistant depression and anxiety.
    </p>
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1.25rem;text-wrap:pretty;">
      Major healthcare systems serving the area include UT Southwestern Medical Center, Baylor Scott & White Health, Methodist Health System, and Texas Health Resources. Isha Health complements these in-system options with a fully telehealth alternative — accessible from Uptown, Oak Lawn, Lakewood, Plano, Frisco, and the Park Cities and anywhere else with a stable internet connection. Sessions are scheduled in your local Central Time, and our physician network is licensed to prescribe in Texas.
    </p>

    <h3 style="font-family:'Libre Baskerville',serif;font-size:1.05rem;font-weight:700;color:#111827;margin-top:1.5rem;margin-bottom:0.5rem;">Mental health context in Dallas</h3>
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1rem;text-wrap:pretty;">
      Dallas's rapid suburban growth has been accompanied by rising rates of teen and young-adult depression in fast-developing communities (Frisco, Plano, McKinney). North Texas DSHS data shows mental-health demand outpacing in-network supply across DFW.
    </p>
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;line-height:1.8;color:#374151;margin-bottom:1rem;text-wrap:pretty;">
      UT Southwestern's Center for Depression Research and Clinical Care is a leading site for ketamine and TMS research and has run multiple TRD trials in recent years. For active studies, see <a href="https://clinicaltrials.gov/search?term=ketamine%20Dallas&aggFilters=status:rec" rel="nofollow" style="color:#0d9488;text-decoration:underline;">recruiting ketamine trials in Dallas on ClinicalTrials.gov</a>.
    </p>
...
${therapistsHtml}
    ...
    <div style="margin-bottom:2rem;">
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How does at-home ketamine therapy work in Dallas?</h3>
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">You meet with a physician over video, receive your prescription by mail at your Dallas address, and complete sessions at home with ongoing clinical support.</p>
      </div>
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        <h3 style="font-family:'Poppins',sans-serif;font-size:0.95rem;font-weight:600;color:#111827;margin-bottom:0.35rem;">How much does ketamine therapy cost in Dallas?</h3>
  ...
  <div style="background-color:#f0fdfa;padding:3rem 1.5rem;text-align:center;border-top:1px solid #ccfbf1;">
    ...
    <p style="font-family:'Poppins',sans-serif;color:#4b5563;margin-bottom:1.5rem;font-size:0.95rem;">Appointments often available within 24 hours for patients in Dallas.</p>
