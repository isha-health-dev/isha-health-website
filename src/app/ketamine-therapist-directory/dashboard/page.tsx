          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <select style={{ ...inputStyle, flex: 1 }} id="new-insurance" defaultValue="">
              ...
              <optgroup label="California">
                ...
                <option value="health_net">Health Net (Centene)</option>
                ...
                <option value="partnership_healthplan_ca">Partnership HealthPlan of CA</option>
              ...
              <optgroup label="New York">
                <option value="empire_bcbs">Empire BCBS / Anthem</option>
                ...
                <option value="fidelis_care">Fidelis Care (Centene)</option>
                ...
                <option value="highmark_bcbs_wny">Highmark BCBS of WNY</option>
              </optgroup>
              ...
              <optgroup label="Arizona">
                <option value="bcbs_arizona">BCBS of Arizona</option>
              ...
              <optgroup label="Florida">
                <option value="florida_blue">Florida Blue (BCBS FL)</option>
                <option value="avmed">AvMed</option>
                <option value="capital_health_plan">Capital Health Plan</option>
                <option value="simply_healthcare">Simply Healthcare (Elevance)</option>
                <option value="sunshine_health">Sunshine Health (Centene)</option>
              ...
              <optgroup label="Oregon">
                ...
                <option value="trillium">Trillium Community Health</option>
              </optgroup>
              <optgroup label="Texas">
                <option value="bcbs_texas">BCBS of Texas</option>
                <option value="baylor_scott_white">Baylor Scott &amp; White Health Plan</option>
                ...
                <option value="superior_healthplan">Superior HealthPlan (Centene)</option>
