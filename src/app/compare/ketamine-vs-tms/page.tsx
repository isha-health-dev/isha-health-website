...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"MedicalWebPage","name":"Ketamine vs TMS: Comparison Guide","url":"https://isha.health/compare/ketamine-vs-tms","lastReviewed":"2026-04-21","audience":{"@type":"MedicalAudience","audienceType":"Patient"},"specialty":{"@type":"MedicalSpecialty","name":"Psychiatric"},"reviewedBy":{"@type":"Person","name":"Mai Shimada, MD","jobTitle":"Psychiatrist","url":"https://isha.health/dr-mai-shimada"}}</script>
  ...
  <div style="max-width:800px;margin:0 auto;padding:1.5rem;">
      ...
      <table style="width:100%;border-collapse:collapse;font-family:'Poppins',sans-serif;font-size:0.9rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding:0.75rem 1rem;border:1px solid #e5e7eb;">Varies widely; at-home oral ketamine may start around $398/appointment + $50-150/mo medication</td>
    ...
    <div style="margin-bottom:2rem;">
      ...
      <div style="border-bottom:1px solid #e5e7eb;padding:1rem 0;">
        ...
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">A full course of TMS may cost $6,000 to $12,000 or more, though some insurance plans cover it. At-home oral ketamine through Isha Health starts at $398 per appointment plus $50-150 per month for medication. See our <a href="/pricing" style="color:#0d9488;text-decoration:underline;">pricing page</a> for details.</p>
      </div>
