...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"MedicalWebPage","name":"Ketamine vs Antidepressants (SSRIs/SNRIs)","url":"https://isha.health/compare/ketamine-vs-antidepressants","lastReviewed":"2026-04-21","audience":{"@type":"MedicalAudience","audienceType":"Patient"},"specialty":{"@type":"MedicalSpecialty","name":"Psychiatric"},"reviewedBy":{"@type":"Person","name":"Mai Shimada, MD","jobTitle":"Psychiatrist","url":"https://isha.health/dr-mai-shimada"}}</script>
      ...
      <table style="width:100%;border-collapse:collapse;font-family:'Poppins',sans-serif;font-size:0.9rem;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="padding:0.75rem 1rem;border:1px solid #e5e7eb;">At-home oral: ~$398/appointment + $50-150/mo medication; generally not covered by insurance</td>
