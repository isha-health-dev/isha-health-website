...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive resources on ketamine therapy for depression, anxiety, PTSD, and more. Guides, research, comparisons, and condition-specific information from Isha Health.',
