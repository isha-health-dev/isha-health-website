...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"MedicalWebPage","name":"Ketamine Therapy for Bipolar Depression","url":"https://isha.health/conditions/bipolar-depression","lastReviewed":"2026-04-21","audience":{"@type":"MedicalAudience","audienceType":"Patient"},"about":{"@type":"MedicalCondition","name":"Bipolar Disorder"},"specialty":{"@type":"MedicalSpecialty","name":"Psychiatric"},"reviewedBy":{"@type":"Person","name":"Mai Shimada, MD","jobTitle":"Psychiatrist","url":"https://isha.health/dr-mai-shimada"}}</script>
  <div style="text-align:center;padding:3rem 1.5rem 1.5rem;">
    <h1 style="font-family:'Libre Baskerville',serif;font-size:2rem;font-weight:700;color:#111827;margin:0;">Ketamine Therapy for Bipolar Depression</h1>
  </div>
  ...
  <div style="max-width:800px;margin:1rem auto 2rem;padding:0 1.5rem;">
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1rem;">Further reading on ketamine and bipolar depression</h2>
    <ul style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.9;padding-left:1.25rem;margin:0;">
    <li><a href="/post/ketamine-bipolar-depression" style="color:#0d9488;text-decoration:none;">Ketamine for bipolar depression: the evidence</a></li>
    <li><a href="/post/evidence-based-psychotherapeutic-approaches-for-bipolar-disorder" style="color:#0d9488;text-decoration:none;">Evidence-based psychotherapy for bipolar disorder</a></li>
    </ul>
  </div>
