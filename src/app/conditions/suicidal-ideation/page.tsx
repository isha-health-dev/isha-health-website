...
export const metadata: Metadata = {
  ...
  description: "Research suggests ketamine may rapidly reduce suicidal thoughts when other treatments have not been effective. Learn about the clinical evidence and how…",
  alternates: { canonical: "https://isha.health/conditions/suicidal-ideation" },
  openGraph: buildOpenGraph({
    title: "Ketamine Therapy for Suicidal Ideation",
    description: "Research suggests ketamine may rapidly reduce suicidal thoughts when other treatments have not been effective. Learn about the clinical evidence and how…",
    path: '/conditions/suicidal-ideation',
  }),
  twitter: {
...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"MedicalWebPage","name":"Ketamine Therapy for Suicidal Ideation","url":"https://isha.health/conditions/suicidal-ideation","lastReviewed":"2026-04-21","audience":{"@type":"MedicalAudience","audienceType":"Patient"},"about":{"@type":"MedicalCondition","name":"Suicidal Ideation"},"specialty":{"@type":"MedicalSpecialty","name":"Psychiatric"},"reviewedBy":{"@type":"Person","name":"Mai Shimada, MD","jobTitle":"Psychiatrist","url":"https://isha.health/dr-mai-shimada"}}</script>
