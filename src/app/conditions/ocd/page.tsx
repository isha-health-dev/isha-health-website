...
export const metadata: Metadata = {
  ...
  description: "Emerging evidence suggests ketamine may help reduce OCD symptoms when standard treatments have not been effective. Learn about the research and how Isha…",
...
export default function Page() {
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"MedicalWebPage","name":"Ketamine Therapy for OCD | Isha Health","url":"https://isha.health/conditions/ocd","lastReviewed":"2026-04-21","audience":{"@type":"MedicalAudience","audienceType":"Patient"},"about":{"@type":"MedicalCondition","name":"Obsessive-Compulsive Disorder"},"specialty":{"@type":"MedicalSpecialty","name":"Psychiatric"},"reviewedBy":{"@type":"Person","name":"Mai Shimada, MD","jobTitle":"Psychiatrist","url":"https://isha.health/dr-mai-shimada"}}</script>
  <div style="text-align:center;padding:3rem 1.5rem 1.5rem;">
    <h1 style="font-family:'Libre Baskerville',serif;font-size:2rem;font-weight:700;color:#111827;margin:0;">Ketamine Therapy for OCD</h1>
  </div>
  ...
  <div style="max-width:800px;margin:0 auto;padding:1.5rem;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1rem;margin-bottom:2rem;">
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
        ...
        <p style="font-family:'Source Sans Pro',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.5;">Get referred for a 60-minute telehealth evaluation with a physician experienced in ketamine-assisted therapy. We assess your OCD symptoms, treatment history, and suitability for ketamine.</p>
      </div>
      <div style="flex:1 1 200px;padding:1.25rem;border:1px solid #e5e7eb;border-radius:10px;background:#fafafa;">
  ...
  <div style="max-width:800px;margin:1rem auto 2rem;padding:0 1.5rem;">
    <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1rem;">Further reading on ketamine and OCD</h2>
    <ul style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.9;padding-left:1.25rem;margin:0;">
    <li><a href="/post/ketamine-ocd-emerging-evidence" style="color:#0d9488;text-decoration:none;">Ketamine for OCD: emerging clinical evidence</a></li>
    <li><a href="/post/six-week-oral-ketamine-trd-ptsd-ocd" style="color:#0d9488;text-decoration:none;">Six weeks of oral ketamine for TRD, PTSD, and OCD</a></li>
    </ul>
  </div>
