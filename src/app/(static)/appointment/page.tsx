...
export default function Page() {
  ...
  <h2 style="font-family:'Libre Baskerville',serif;font-size:1.3rem;font-weight:700;color:#111827;margin-bottom:1.25rem;">How to Get Referred</h2>
  ...
  <div style="display:grid;gap:1.25rem;margin-bottom:2.5rem;">
    ...
    <div style="border:1px solid #e5e7eb;border-radius:10px;padding:1.5rem;">
      <p style="font-family:'Poppins',sans-serif;font-size:0.8rem;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;color:#0d9488;margin-bottom:0.5rem;">If you already have a therapist</p>
