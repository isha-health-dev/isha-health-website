...
const TITLE = "Schedule Your Initial Consultation";
const DESCRIPTION = "Private scheduling link for patients referred to Isha Health by a collaborating therapist.";

// Unlisted page. Shared manually with referred patients only: not linked from
// the site, not in sitemap.ts's staticPages list, and noindex/nofollow below.
// Deliberately NOT added to robots.ts — a Disallow rule would publish this
// URL in the public robots.txt, which is the opposite of hiding it.
...
export default function Page() {
  ...
  <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:1.5rem;margin-bottom:2rem;">
    <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.7;margin-bottom:1rem;">
      This scheduler is for patients who have been <strong>referred by a collaborating therapist</strong>. If you are currently receiving treatment with us, please schedule on the <a href="/current-patients/scheduling" style="color:#0d9488;text-decoration:underline;">Current Patients page</a>.
    </p>
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.85rem;color:#6b7280;line-height:1.6;">
      No availability showing? Email <a href="mailto:info@isha.health" style="color:#0d9488;text-decoration:underline;">info@isha.health</a> &mdash; we may be able to accommodate you sooner.
    </p>
  </div>
