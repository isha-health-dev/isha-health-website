...
<div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;font-family:Poppins,sans-serif;color:#374151;line-height:1.8;">
  ...
  <div style="background:#f0fdfa;border:1px solid #ccfbf1;border-radius:10px;padding:1.5rem;margin:2rem 0;">
    <h3 style="font-family:Libre Baskerville,serif;font-size:1.1rem;font-weight:700;color:#0f766e;margin-bottom:0.75rem;">Isha Health Patient Outcomes</h3>
    ...
    <p style="font-size:0.85rem;color:#6b7280;"><a href="/outcomes" style="color:#0d9488;text-decoration:underline;">View full clinical outcomes report →</a></p>
  </div>

  <div style="margin:1.5rem 0;">
    <h3 style="font-family:Libre Baskerville,serif;font-size:1.1rem;font-weight:700;color:#111827;margin-bottom:0.75rem;">Start Treatment</h3>
  ...
  <div style="margin:1.5rem 0;">
    <p style="font-size:0.9rem;font-weight:600;color:#111827;margin-bottom:0.5rem;">Related:</p>
    <div style="display:flex;flex-wrap:wrap;gap:0.25rem;">
      <a href="/conditions/ptsd" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:Poppins,sans-serif;font-size:0.8rem;margin:0.2rem;">PTSD</a>
      <a href="/conditions/ocd" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:Poppins,sans-serif;font-size:0.8rem;margin:0.2rem;">OCD</a>
      <a href="/compare/ketamine-vs-therapy" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:Poppins,sans-serif;font-size:0.8rem;margin:0.2rem;">Ketamine vs Therapy</a>
      <a href="/compare/at-home-ketamine-vs-clinic" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:Poppins,sans-serif;font-size:0.8rem;margin:0.2rem;">At-Home vs Clinic</a>
    </div>
  </div>
