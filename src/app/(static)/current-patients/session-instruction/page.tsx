  ...
  <div style="margin-bottom:2.5rem;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
    ...
    <div style="padding:1.5rem;">
      ...
      <div style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;margin-bottom:1.5rem;">
        ...
        <p style="margin-bottom:1rem;">One important aspect of ketamine therapy is setting intentions for the experience. By clarifying what you hope to achieve from the session, you can maximize the potential benefits of the medication and create a more focused and purposeful experience. Here are some tips for <a href="https://www.isha.health/post/intention-setting-for-ketamine-treatment" style="color:#0d9488;text-decoration:underline;">setting intentions for a ketamine therapy session</a>.</p>
        ...
        <p style="margin-bottom:1rem;">Share <a href="https://www.isha.health/support-person-overview" style="color:#0d9488;text-decoration:underline;">this link</a> with your Support Person and ask them to review it before your session.</p>
  ...
  <div style="margin-bottom:2.5rem;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
    ...
    <div style="padding:1.5rem;">
      ...
      <div style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;">
        ...
        <p style="margin-bottom:1rem;">Take some time to journal now that you have reflected on your experience. As you journal, focus on identifying a single, core action that you can take this week to make progress towards your goals. This is an opportunity to use your insights from your <a href="https://www.isha.health/post/9-things-you-should-do-before-your-ketamine-dosing-sessions" style="color:#0d9488;text-decoration:underline;">ketamine therapy session</a> to develop a tangible plan for personal growth. Write down your integration action in your journal and commit to taking action on it this week. By committing to taking action, you can translate your insights and intentions into real-world changes that can help you achieve greater well-being and fulfillment. Remember to give yourself permission to be patient and compassionate with yourself as you work towards your goals.</p>
        <h4 style="font-family:'Libre Baskerville',serif;font-size:1rem;color:#111827;margin-bottom:0.5rem;">Integration Circles</h4>
        <p>We highly encourage you to work with a ketamine psychotherapist for integration. You can reach out to a psychotherapy session with our experienced <a href="https://www.isha.health/post/why-do-i-need-a-therapist-for-ketamine-treatment" style="color:#0d9488;text-decoration:underline;">ketamine therapist</a> from <a href="https://findyourkaptherapist.isha.health/" style="color:#0d9488;text-decoration:underline;">here</a>. We also have a resource where you can find donation based <a href="https://www.isha.health/post/online-integration-circles-for-ketamine-therapy" style="color:#0d9488;text-decoration:underline;">integration circles</a> that may meet your needs.</p>
      </div>
    </div>
  </div>
  ...
  <div style="margin-bottom:2.5rem;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
    ...
    <div style="padding:1.5rem;">
      ...
      <div style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;">
        ...
        <h4 style="font-family:'Libre Baskerville',serif;font-size:1rem;color:#111827;margin-bottom:0.5rem;">Integration Circles</h4>
        <p>We highly encourage you to work with a ketamine psychotherapist for integration. You can book a psychotherapy session with our experienced <a href="https://www.isha.health/post/why-do-i-need-a-therapist-for-ketamine-treatment" style="color:#0d9488;text-decoration:underline;">ketamine therapist</a> from <a href="https://findyourkaptherapist.isha.health/" style="color:#0d9488;text-decoration:underline;">here</a>. We also have a resource where you can find donation based <a href="https://www.isha.health/post/online-integration-circles-for-ketamine-therapy" style="color:#0d9488;text-decoration:underline;">integration circles</a> that may meet your needs.</p>
      </div>
    </div>
  </div>
  ...
  <div style="margin-bottom:2.5rem;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
    ...
    <div style="padding:1.5rem;">
      ...
      <div style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;">
        ...
        <h4 style="font-family:'Libre Baskerville',serif;font-size:1rem;color:#111827;margin-bottom:0.5rem;">Integration Circles</h4>
        <p>We highly encourage you to work with a ketamine psychotherapist for integration. You can book a psychotherapy session with an experienced <a href="https://www.isha.health/post/why-do-i-need-a-therapist-for-ketamine-treatment" style="color:#0d9488;text-decoration:underline;">ketamine therapist</a> from <a href="https://findyourkaptherapist.isha.health/" style="color:#0d9488;text-decoration:underline;">here</a>. We also have a resource where you can find donation based <a href="https://www.isha.health/post/online-integration-circles-for-ketamine-therapy" style="color:#0d9488;text-decoration:underline;">integration circles</a> that may meet your needs.</p>
      </div>
    </div>
  </div>
