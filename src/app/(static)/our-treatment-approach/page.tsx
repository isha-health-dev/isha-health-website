...
<div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem 3rem;">
  ...
  <div style="margin-bottom:2.5rem;">
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;margin-bottom:1.5rem;">Please <a href="https://www.isha.health/consent-form" style="color:#0d9488;text-decoration:underline;">review our ketamine consent form</a> for more information and disclosures.</p>
