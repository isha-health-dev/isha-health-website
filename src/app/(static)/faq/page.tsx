...
export default function Page() {
  ...
  <h1 style="font-family:'Libre Baskerville',serif;font-size:2.2rem;font-weight:700;color:#111827;text-align:center;margin-bottom:0.5rem;">Frequently Asked Questions</h1>
  <p style="font-family:'Poppins',sans-serif;font-size:1rem;color:#6b7280;text-align:center;margin-bottom:3rem;">Everything you need to know about ketamine therapy at Isha Health</p>
    ...
    <div style="margin-bottom:2rem;">
      ...
      <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.7;padding-left:1rem;">Yes, ketamine is **legal** when prescribed by a licensed provider. It is **FDA-approved** as an anesthetic and used **off-label** for mental health conditions like **depression and PTSD**. **Spravato (esketamine)** is an **FDA-approved** nasal spray for treatment-resistant depression. Recreational use is illegal.<br/><br/><a href="https://www.isha.health/post/is-ketamine-legal" style="color:#0d9488;text-decoration:underline;">Learn more →</a></p>
    </div>
    <div style="margin-bottom:2rem;">
    ...
    <div style="margin-bottom:2rem;">
      ...
      <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.7;padding-left:1rem;">While ketamine therapy is generally considered safe and effective, there are potential risks associated with the treatment. These may include impaired balance and coordination, blurred vision, slurred speech, confusion, excitability, anxiety, nausea, and vomiting. Ketamine can also cause a significant increase in blood pressure and heart rate. In rare cases, ketamine can worsen certain psychotic symptoms in individuals with serious mental disorders. During the treatment itself, some people may experience frightening or unusual experiences, which is part of the therapeutic process. It is important to receive psychotherapeutic help and ongoing guidance from your therapist during ketamine therapy.<br/><br/>Please <a href="https://www.isha.health/consent-form" style="color:#0d9488;text-decoration:underline;">review our ketamine consent form</a> for more information and disclosures.</p>
    </div>
    <div style="margin-bottom:2rem;">
    ...
    <div style="margin-bottom:2rem;">
      ...
      <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#4b5563;line-height:1.7;padding-left:1rem;">Yes, but staying awake is ideal. **Even if you doze off, **<a href="https://www.isha.health/post/how-does-ketamine-work" style="color:#0d9488;text-decoration:underline;">**ketamine still works on a biological level**</a>, promoting **neuroplasticity and mood improvements**.<br/><br/>🔹 If you’re very sleep-deprived, consider **rescheduling** to stay more engaged in the experience.<br/>🔹 A **guided session** or **light music** can help keep you present.</p>
    </div>
    <div style="margin-bottom:2rem;">
