...
export const metadata: Metadata = {
  ...
  description: "88.8% of patients with moderate-to-severe depression improve with ketamine therapy. Physician-led, at-home treatment starting at $398.",
  alternates: {
...
<div style="max-width:800px;margin:0 auto;padding:2rem 1.5rem;">
  ...
  <div style="margin-bottom:2.5rem;">
    ...
    <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:1.25rem 1.5rem;margin-bottom:1rem;">
      ...
      <p style="font-family:'Poppins',sans-serif;font-size:0.95rem;color:#374151;line-height:1.7;margin:0;">
        Based on your consultation, your physician will design a treatment plan including dosing, session frequency, and integration support to maximize therapeutic benefit.
      </p>
    </div>
  </div>
  ...
  <div style="background:#f0fdfa;border:1px solid #ccfbf1;border-radius:10px;padding:1.5rem;margin:2rem 0;">
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#374151;line-height:1.6;margin:0 0 0.5rem;">
      88.8% of Isha Health patients with moderate-to-severe depression show measurable improvement based on PHQ-9 assessments across over 500 patients. Our patients see their first improvement in an average of 1.29 sessions.
    </p>
    <p style="font-family:'Poppins',sans-serif;font-size:0.85rem;color:#6b7280;margin:0;">
      <a href="/outcomes" style="color:#0d9488;text-decoration:underline;">View full clinical outcomes report &rarr;</a>
    </p>
  </div>
  ...
  <div style="margin:2rem 0;">
    ...
    <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;color:#374151;line-height:1.6;">
      Isha Health offers <a href="/online-ketamine-therapy" style="color:#0d9488;text-decoration:underline;">online ketamine therapy</a> via telemedicine in 9 states. Initial consultations are <a href="/ketamine-therapy-cost" style="color:#0d9488;text-decoration:underline;">$398 for 60 minutes</a> with a physician. <a href="/ketamine-therapy-reviews" style="color:#0d9488;text-decoration:underline;">Read patient reviews</a> or <a href="/guide/ketamine-for-depression" style="color:#0d9488;text-decoration:underline;">explore our complete guide</a>.
    </p>
  </div>
  ...
  <div style="margin:2rem 0 1rem;">
    <p style="font-family:'Poppins',sans-serif;font-size:0.9rem;font-weight:600;color:#111827;margin-bottom:0.5rem;">
      Related:
    </p>
    <div style="display:flex;flex-wrap:wrap;gap:0.25rem;">
      <a href="/conditions/treatment-resistant-depression" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Treatment-Resistant Depression</a>
      <a href="/conditions/bipolar-depression" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Bipolar Depression</a>
      <a href="/conditions/suicidal-ideation" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Suicidal Ideation</a>
      <a href="/compare/ketamine-vs-antidepressants" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Ketamine vs Antidepressants</a>
      <a href="/compare/ketamine-vs-tms" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Ketamine vs TMS</a>
      <a href="/compare/ketamine-vs-ect" style="display:inline-block;padding:0.4rem 0.8rem;border:1px solid #d1d5db;border-radius:6px;text-decoration:none;color:#374151;font-family:'Poppins',sans-serif;font-size:0.8rem;margin:0.2rem;">Ketamine vs ECT</a>
    </div>
  </div>
